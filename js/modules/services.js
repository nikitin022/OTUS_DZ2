// services.js — модуль услуг и прайса.
...
/**
 * Массив услуг. Схема элемента (см. Шаг 1 плана CoT):
 ...
 * При отсутствии контейнера или пустых данных просто завершается (progressive enhancement).
 */
